package org.jason.moudule.dao.hibernate.base;

import org.hibernate.Query;
import org.hibernate.Session;
import org.hibernate.SessionFactory;
import org.jason.moudule.dao.exception.DaoException;
...
public abstract class DaoBaseImpl<T> implements DaoBase<T> {
    ...
    public void save(T entity) {
        try {
            ...
            throw new DaoException("保存实体失败",e);
        }
    }
    ...
    public void update(T entity) {
        try {
            ...
            throw new DaoException("更新实体失败",e);
        }
    }
    ...
    public void merge(T entity) {
        try {
            ...
            throw new DaoException("merge实体失败",e);
        }
    }
